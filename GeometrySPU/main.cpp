...
#define SHAPE_GIVE_PARAMETERS	color, start_x, start_y, line_width
	...
	public:
		...
		void draw()const
		{
			...
			//hPen и hBrush это, чем будем рисовать
			// Выбираем чем и на чем будем рисовать
			SelectObject(hdc, hPen);
			SelectObject(hdc, hBrush);
			//Когда мы выбрали чем и на чем, рисуем фигуру
...
void main()
{
	...
	Geometry::Square square(100, Geometry::Color::console_red, 300, 100, 5);
	...
	Geometry::Rectangle rect(100, 70, Geometry::Color::blue, 230, 100, 5);
	rect.info();
}